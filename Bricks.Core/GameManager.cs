...
{
    public class GameManager : Bricks.Core.IView
    {
        ...
        public void InitializeBoard(string shapeParam)
        {
            presenter.InitializeBoard(shapeParam);
        ...
        public void DisplayScore(int score, int hiScore, int lines, int level, Bricks.Core.Shapes.IShape next)
        {
